...
def trade_preprocessor(data, rolling=60):
    ...
    df['depth_1s_buy_vwap_rolling_300_quantile_75'] = df['buy_vwap_vwap'].rolling(rolling * 5).quantile(.75)
    ...
    df['depth_1s_sell_vwap_rolling_300_quantile_750'] = df['sell_vwap_vwap'].rolling(rolling * 5).quantile(.75)
    ...
    df['trade_price_miuns'] = df['sell_vwap'] - df['buy_vwap']
